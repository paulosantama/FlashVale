...
class meuResetaSenha extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->greeting('Olá!')
                    ->line('Você está recebendo este e-mail porquê nós recebemos uma solicitação de redefinição de senha para sua conta.')
