...
@section('content')
    <div class="container">
        ...
        ?>
        @if((Request::is('*funcionario*'))||((Auth::user()->empresa_id==null)&&(Auth::user()->funcionario_id!=null)))
            <?php
        ...
        @if(($funcionario->ativo==1))
            <div class="row">
                ...
                <div class="col-md-2 col-6 mt-2" style="height: 150px;">
                    <a href="{{ url('vale/solicitar') }}" class="ocultLink">
                        <div class="itemPrincipal text-center">
                            <table height="100%" width="100%">
                                <tr>
                                    <td class="align-middle">
                ...
                <div class="col-md-2 col-6 mt-2" style="height: 150px;">
                    <a href="{{ url('folha/'.$funcionario->id.'/visualizar') }}" class="ocultLink">
                        <div class="itemPrincipal text-center">
                            <table height="100%" width="100%">
                                <tr>
                                    <td class="align-middle">
